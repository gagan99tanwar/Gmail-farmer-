...
# ============================================================
# SEND NEW BOT MESSAGE TO OLD BOT
# ============================================================

async def send_message_to_old_bot(message):
...
# ============================================================
# WAIT FOR OLD BOT RESPONSE
# ============================================================

async def wait_for_old_bot_replies():
    ...
    try:
        ...
        async with user_client.conversation(
            ...
            # The actual request has already been sent.
...
async def process_job(job: RelayJob):
    ...
    try:
        ...
        # Send request to old bot.
        await send_message_to_old_bot(
            job.message
        )

        # Wait for old bot.
        replies = await wait_for_old_bot_replies()
